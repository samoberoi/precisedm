...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "html", html: 'These questions require structured answers. Without a framework that organises the relevant information and applies consistent logic to the adjustment decision, the process relies on individual clinical memory and experience, producing the variability that <a href="https://precisedm.com/features">structured insulin dose adjustment tools</a> are designed to reduce.' },
