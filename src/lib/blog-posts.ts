...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "html", html: 'This variability, familiar from diabetes care generally but more consequential here, is what makes <a href="https://www.precisedm.com/features" target="_blank" rel="noopener">personalized diabetes care tools</a> so important in gestational diabetes management. A tool that helps a clinician work through the specific variables for the specific patient, and produce guidance that is tailored to that patient rather than generalised across a population, is more likely to support the kind of individualised decision-making that good gestational diabetes care requires.' },
